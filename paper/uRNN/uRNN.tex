...
\author{
\hspace{29.5mm} Martin Arjovsky \thanks{Indicates first authors. Ordering determined by coin flip.} ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Amar Shah \samethanks \\
\hspace{22.5mm} Universidad de Buenos Aires \hspace{11mm} University of Cambridge\\
\hspace{23.25mm} \texttt{marjovsky@dc.uba.ar} \hspace{13.5mm} \texttt{as793@cam.ac.uk}
\AND
...
Complex valued representation has been considered for neural networks in the past, 
...
and uniformly at random. The mean categorical cross entropy of this strategy is $\frac{10 \log(8) }{T+20}$. 
...
On the correct ordering of MNIST pixels, the LSTM performs better, achieving 98.2 \% 
